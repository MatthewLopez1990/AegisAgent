...
const fallbackTools = [
  ...
  { name: "skills", status: "on", scope: "passive discovery / gated manifest write", approval: "ask write", risk: "medium", description: "Discover SKILL.md folders passively and write optional checksum manifests only after approval." },
