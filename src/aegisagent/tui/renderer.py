...
def _posture_panel(width: int, height: int) -> list[str]:
    ...
    rows = [
        ...
        _panel_rule(width),
        _panel_line("provider   local; /model doctor", width),
        _blank_panel(width),
        ...
        _panel_line("agents     /agents live | /agents bg", width),
        _panel_line("monitor    /agents monitor <job>", width),
        _blank_panel(width),
        ...
        _blank_panel(width),
        _panel_line("audit      /audit verifies chain", width),
        _blank_panel(width),
