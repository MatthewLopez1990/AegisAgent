            ...
            tool_results.append(
                RuntimeToolResult(
                    ...
                    metadata={
                        ...
                        "synthesis_id": delegation.root.final_synthesis.get("id", ""),
                        "synthesis_artifact_id": delegation.root.final_synthesis.get("artifact_id", ""),
                        "artifact_graph_node_count": len(delegation.root.final_synthesis.get("artifact_graph", {}).get("nodes", [])),
                        "artifact_graph_edge_count": len(delegation.root.final_synthesis.get("artifact_graph", {}).get("edges", [])),
