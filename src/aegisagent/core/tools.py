...
DEFAULT_TOOLS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec("skills", "extension", "on", "passive discovery / gated manifest write", "ask write", "medium", "Discover SKILL.md folders passively and write optional checksum manifests only after approval."),
